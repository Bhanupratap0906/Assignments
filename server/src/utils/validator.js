 ...
 * 
 * This module validates input objects against a schema and transforms raw input
 * into properly formatted data according to business rules.
 */
...
// Borrow action validation schema
const borrowSchema = {
  userId: {
    type: 'string',
    required: true
...
// Return action validation schema
const returnSchema = {
  userId: {
    type: 'string',
    required: true
